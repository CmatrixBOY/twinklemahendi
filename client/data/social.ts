...
export const socialFeed: SocialCard[] = [
  {
    ...
    excerpt: "Swipe through the reel to watch the pistachio-glass palette shimmer in the morning light.",
    imageUrl:
  ...
  },
  {
    ...
    excerpt: "Curated floral jaalis, terracotta-glow lighting, and pistachio accents for intimate courtyards.",
    imageUrl:
  ...
  },
  {
    ...
    excerpt: "The Shah family shares how every generation now celebrates with Twinkle's artistry.",
    imageUrl:
