      ...
      <DialogContent className="glass-card border-none sm:max-w-xl">
        <DialogHeader>
          <DialogTitle className="section-heading text-center">
            {hasChosenLanguage
              ? strings.languageModal.title
              : fallbackStrings.languageModal.title}
          </DialogTitle>
            ...
            <label
              ...
              className={cn(
                ...
                selected === option.code
                  ? "shadow-glow ring-2 ring-primary/60"
        ...
        <div className="flex flex-col gap-2">
          ...
          >
            {hasChosenLanguage
              ...
              : fallbackStrings.languageModal.button}
          </Button>
          <p className="text-center text-xs text-muted-foreground">
            {hasChosenLanguage
              ? strings.languageModal.reminder
              : fallbackStrings.languageModal.reminder}
          </p>
        </div>
      </DialogContent>
    </Dialog>
