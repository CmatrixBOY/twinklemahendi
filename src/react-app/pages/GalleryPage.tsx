                  ...
                  <div className="flex flex-wrap gap-2">
                    {sortOptions.map((option) => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-full font-medium transition-all duration-300 flex items-center space-x-2 text-xs md:text-sm ${
                          sortBy === option.id
                  ...
                  <div className="flex flex-wrap gap-2">
                    {priceRanges.map((range) => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-full font-medium transition-all duration-300 text-xs md:text-sm ${
